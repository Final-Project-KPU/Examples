...
public class Triangulation {
    ...
    public Triangulation(UWBConfiguration uwbConfiguration) {
        this.uwbConfiguration = uwbConfiguration;
        scale= uwbConfiguration.scale;
    }
        ...
        for(RangingData rangingData : tag.rangeData)
        {
            for(RangingData rangingData2 : tag.rangeData)
            {
                if(loopCounter1<loopCounter2)
                {
                    ...
                    System.out.println("triangulation with:"+anchor1.getName()+" and "+anchor2.getName());
                    ...
                    System.out.println("tag:"+tag.adress+" x:"+tagx+" y:"+tagy);
    ...
    public void dataToTag(String aName, String tName, double distance) {
        ...
        {
            if(tags.get(i).adress.equals(tName))
            {
    ...
    public String getJsonOutput() {
        ...
        JsonArrayBuilder tagsArray = factory.createArrayBuilder();
            ...
            for(Tag tag : tags) {
                if(tag.getLocation()!=null) {
                    builder = factory.createObjectBuilder()
                            .add("name", tag.adress)
                            .add("X", (int)tag.getLocation().getX())
                            .add("Y", (int)tag.getLocation().getY());
                    tagsArray.add(builder);
                }
            }
        }

        JsonObject value = factory.createObjectBuilder()
                .add("coordinates", tagsArray).build();
